...
full_mod <- lm(
  N_Back_Accuracy ~ Sleep_Hours + Sleep_Quality_Score + Daytime_Sleepiness +
    Stress_Level + Caffeine_Intake + PVT_Reaction_Time +
    Physical_Activity_Level + Age + BMI + Gender,
  data = sleep_df
)
