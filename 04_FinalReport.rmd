...
```{r, echo=FALSE}
full_mod <- lm(Cognitive_Score ~ Age + Gender + Sleep_Duration + Stress_Level + Daily_Screen_Time + Exercise_Frequency + Caffeine_Intake + Reaction_Time, data = sleep_df)
...
The significant predictive variables determined through multiple linear regression 
